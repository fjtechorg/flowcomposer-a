<div id="operator_typing_new" class="modal fade" role="dialog">  
<div class="modal-dialog">    
	 ...
	 <button type="button" class="btn btn-primary save_typing_msg" data-dismiss="modal">Save Settings</button>     
</div>    </div>  </div></div>