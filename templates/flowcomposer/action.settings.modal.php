<div id="action_card_settings" class="modal fade flowcomposer-modal" role="dialog">
                                ...
                                <div class="col-lg-12 styling_noleftpadding">
                                    ...
                                    <div id="action_type_container">
                                        ...
                                        <select class="form-control" data-action="action-type-select" >
                                            ...
                                            <option value="set_global_field_value">Set Global Field Value</option>
                                            <option value="clear_global_field">Clear Global Field</option>
                                            <option value="pause_automation">Pause Bot Automation</option>
                                            <option value="resume_automation">Resume Bot Automation</option>
                                            <option value="notify_admin">Notify via Messenger</option>
                                            <option value="clear_input">Clear Required Input</option>
                                            <option value="subscribe">Subscribe to Bot</option>
                                            <option value="unsubscribe">Unsubscribe from Bot</option>
                                            <option value="delete_profile">Delete Subscriber</option>
                                            <option value="export_profile">Send Subscriber Data</option>
                                        </select>
                                    </div>
