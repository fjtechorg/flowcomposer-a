                        ...
                        <div class="tab-content">
                            ...
                            <div id="<?php echo $cardType ?>_settings" class="tab-pane active">
                                ...
                                <div class="col-lg-7 styling_noleftpadding">
                                    ...
                                    <label>Save email to custom field</label>
                                    <span style="color: #0a82fb">- Only custom fields of type email will appear below</span>
                                    <?php

                                    $customfields = getAllCustomfieldsData($_SESSION['page_id'],"email");
