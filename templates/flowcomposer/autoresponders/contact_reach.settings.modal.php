                                ...
                                <div class="col-lg-12 styling_noleftpadding">
                                   ...
                                   echo getAccountSelectorDiv($cardType);
                                    ...
                                    <div id="" class="action-container create_list_contact_action_settings_container" style="display: none">
                                        ...
                                        echo getServiceLists("Contact Reach");
                                        ?>

                                        <label>Phone Number</label>
                                        <input data-action="autoresponder-phone-value" name="phone_value" value="" class="form-control pickers" placeholder="Specify your subscriber's phone number">
                                        <?php echo '<div data-target="text-personalization"></div><div data-target="air-picker"></div>' ?>

                                        <label>Email</label>
                                        <input data-action="autoresponder-email-value" name="email_value" value="" class="form-control pickers" placeholder="Specify your subscriber's email address">
                                        <?php echo '<div data-target="text-personalization"></div><div data-target="air-picker"></div>' ?>
                                    ...
                                    <div id="" class="action-container delete_list_contact_action_settings_container" style="display: none">
                                        ...
                                        <input data-action="autoresponder-email-value" name="email_value" value="" class="form-control pickers" placeholder="Specify the email value">
