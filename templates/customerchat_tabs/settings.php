<div class="tab settings">
    ...
    <input type="radio" id="widget-type-1" name="widget_type" value="bar" style="display:none;">
        ...
        <p class="widget-sub-headings">URL Parameters to Custom Fields<span class="tip-span pull-right"  data-toggle="tooltip" title="" data-placement="right" data-original-title="If your page URL is : http://yourwebsite.tld/?email=test@test.com&points=1000 , to capture the email and points parameters in the above example and set them as custom fields.">?</span></p>
